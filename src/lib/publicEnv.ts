export const PUBLIC_ENV = {
    ...
    OG_IMAGE: process.env.NEXT_PUBLIC_OG_IMAGE || '',
    OG_IMAGE_WIDTH: process.env.NEXT_PUBLIC_OG_IMAGE_WIDTH || '',
    OG_IMAGE_HEIGHT: process.env.NEXT_PUBLIC_OG_IMAGE_HEIGHT || '',
    GOOGLE_SITE_VERIFICATION:
        process.env.NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION || '',
    ORG_LOGO_URL: process.env.NEXT_PUBLIC_ORG_LOGO_URL || '',
    ORG_SAME_AS: process.env.NEXT_PUBLIC_ORG_SAME_AS || '',
