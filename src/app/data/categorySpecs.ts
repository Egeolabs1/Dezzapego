...
const IMOVEIS_PROPERTY_DETAIL_FIELDS: CategoryField[] = [
    { name: 'det_academia', label: 'Academia', type: 'checkbox' },
    { name: 'det_aquecimento', label: 'Aquecimento', type: 'checkbox' },
    { name: 'det_ar_condicionado', label: 'Ar condicionado', type: 'checkbox' },
    { name: 'det_area_servico', label: 'Área de serviço', type: 'checkbox' },
    { name: 'det_armarios_cozinha', label: 'Armários na cozinha', type: 'checkbox' },
    { name: 'det_armarios_quarto', label: 'Armários no quarto', type: 'checkbox' },
    { name: 'det_banheiro_suite', label: 'Banheiro no quarto', type: 'checkbox' },
    { name: 'det_churrasqueira', label: 'Churrasqueira', type: 'checkbox' },
    { name: 'det_internet', label: 'Internet', type: 'checkbox' },
    { name: 'det_mobiliado', label: 'Mobiliado', type: 'checkbox' },
    { name: 'det_piscina', label: 'Piscina', type: 'checkbox' },
    { name: 'det_porteiro_24h', label: 'Porteiro 24h', type: 'checkbox' },
    { name: 'det_quarto_servico', label: 'Quarto de serviço', type: 'checkbox' },
    { name: 'det_salao_festas', label: 'Salão de festas', type: 'checkbox' },
    { name: 'det_tv_cabo', label: 'Tv a cabo', type: 'checkbox' },
    { name: 'det_varanda', label: 'Varanda', type: 'checkbox' },
];

const IMOVEIS_CONDO_DETAIL_FIELDS: CategoryField[] = [
    { name: 'cond_academia', label: 'Academia', type: 'checkbox' },
    { name: 'cond_area_murada', label: 'Área murada', type: 'checkbox' },
    { name: 'cond_fechado', label: 'Fechado', type: 'checkbox' },
    { name: 'cond_elevador', label: 'Elevador', type: 'checkbox' },
    { name: 'cond_permite_animais', label: 'Permitido animais', type: 'checkbox' },
    { name: 'cond_piscina', label: 'Piscina', type: 'checkbox' },
    { name: 'cond_portao_eletronico', label: 'Portão eletrônico', type: 'checkbox' },
    { name: 'cond_portaria', label: 'Portaria', type: 'checkbox' },
    { name: 'cond_salao_festas', label: 'Salão de festas', type: 'checkbox' },
    { name: 'cond_seguranca_24h', label: 'Segurança 24h', type: 'checkbox' },
];
